    ...
    App::new()
        .add_plugins(DefaultPlugins.set(WindowPlugin {
            primary_window: Some(Window {
                title: "Haniba VFX - Black Hole Accretion Disk".to_string(),
...
fn spawn_effect(
    ...
    // Spawn blackhole effect
    if keyboard.just_pressed(KeyCode::Space) {
        info!("Spawning blackhole effect at {:?}", cursor_world_pos);
        commands.trigger(HanabiEvent::new("blackhole"cursor_world_pos));
    }
}
